...
# Now set the variable tag. If only one annotated tag points to the current
# commit, we use that tag. If more than one annotated tag points to the current
# commit, the user has to provide the tag as an input to the script.
# If there is no annotated tag, this is a nightly snapshot "release".
